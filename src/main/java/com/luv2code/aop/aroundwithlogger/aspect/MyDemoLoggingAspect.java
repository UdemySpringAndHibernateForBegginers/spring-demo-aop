...
import com.luv2code.aop.aroundwithlogger.model.Account;
...
public class MyDemoLoggingAspect {
    ...
    @AfterReturning(
            pointcut = "execution(* com.luv2code.aop.aroundwithlogger.dao.AccountDao.findAccounts(..))",
            returning = "result"
    )
    ...
    @After("execution(* com.luv2code.aop.aroundwithlogger.dao.AccountDao.findAccounts(..))")
    ...
    @Around("execution(* com.luv2code.aop.aroundwithlogger.service.*.getFortune(..))")
